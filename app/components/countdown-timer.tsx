...
const CountdownTimer: React.FC = () => {
   ...
   const targetDate = new Date('2024-10-22T16:00:00');
   const targetDateTime = new Date('2024-10-22T16:00:00').getTime();
   const nextPostDate: any = new Date('2024-10-30T16:00:00');
